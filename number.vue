<template>
  <div class="weui-cell">
    ...
    <div class="weui-cell__ft mt-cell-primary" :class="{'mt-number-round': buttonStyle === 'round'}" v-show="!readonly" style="font-size:0">
    ...
    <div class="weui-cell__ft mt-cell-primary" v-show="readonly">
      {{value}}
    </div>
  </div>
</template>
